...
function parseCollaborator($collaborator) {
    ...
    return array(trim($str[0]), trim($str[1]));
}
 ...
 *  @param boolean $withPeriods - whether or not to delimit the intiilaism with Periods.
 ...
 * @param boolean $assoc  - (Optional) Determines the return type of this function.
