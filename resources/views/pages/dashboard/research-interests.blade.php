    ...
    <div class="row">
      <div class="col-lg-3">
        ...
        <div class="col-lg-9">
            ...
            {{ Form::open(['class' => 'interests' , 'url' => route('research-interests.store')]) }}
            <div class="row">
                <div class="form__group">
                    <div class="col-sm-12">
                        @if (count($currentInterests) > 0)
                            <h2 class="type--thin">Current Research Interests</h2>
                            @foreach($currentInterests as $interest)
                                <a class="tag tag--danger tag--normal tag--removable interest"
                                   href="{{ route('interest.destroy', ['id' => $interest->attribute_id]) }}"
            ...
            <div class="row">
                <div class="col-sm-12">
                    <h2 class="type--thin">Add Research Interests</h2>
                </div>
            </div>
            <div class="row">
              <div class="col-sm-6">
...
<script type="text/javascript">
    ...
    $(".select2-tags").select2({
        ...
        language: {
            noResults: function(){
                return 'No results found. Create your own by typing the Research Interest and then pressing Enter...';
            }
        },
