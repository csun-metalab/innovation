<nav class= "@yield('nav', 'primary-nav')">
  <div class="container">
    ...
    <li><a title="Home" href="{{ urlAppName("/") }}" class="primary-nav__link {{ setActive(['/']) }}">Home</a></li>
    <li><a title="Explore Projects" href="{{ urlAppName('/project') }}" class="primary-nav__link {{ setActive(['project*','admin*']) }}">Projects</a></li>
    <li><a title="About" href="{{ urlAppName("/about/version-history") }}" class="primary-nav__link {{ setActive(['about*']) }}">About</a></li>
    @if (Auth::check())
    <li class="drop">
    ...
    <div class="dropdownContain">
      <div class="dropOut">
        ...
        <ul>
          ...
          @endif
          <li title="Sign Out" class="{{ setActive(['admin/logout'])   }}"><a href="{{ urlAppName('logout') }}" class="drop-down__link" title="Logout"> Sign Out  <i class="fa fa-sign-out" aria-hidden="true"></i>
          </a></li>
       </ul>
      </div>
    </div>
    ...
    @else
    <li class="{{ setActive(['login']) }}"><a href="{{ urlAppName('/login') }}" class="primary-nav__link" title="Login">Login <i class="fa fa-lock" aria-hidden="true"></i></a></li>
    @endif
    </ul>
  </div>
</nav>
