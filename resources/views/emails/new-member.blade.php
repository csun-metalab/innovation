...
<body width="100%" bgcolor="#ffffff" style="margin: 0;">
    <center style="width: 100%; background: #FFFFFF;">
                ...
                <tr>
                    <td bgcolor="#ffffff">
                        <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                            <tr>
                                <td style="padding: 40px; font-weight: 300; text-align: center; font-family: sans-serif; font-size: 40px; mso-height-rule: exactly; color: #000000;">
                                   <center>{{ $member->first_name }} {{ $member->last_name }} has joined the project <br> {{ $project->project_title }}! </center>
                                    <br><br>
                                    <!-- Button : BEGIN -->
                                    ...
                                    <table role="presentation" cellspacing="0" cellpadding="0" border="0" align="center" style="margin: auto">
                                        <tr>
                                            <td style="padding: 40px; font-weight: 200; text-align: center; font-family: sans-serif; font-size: 30px; mso-height-rule: exactly; color: #555555;">{{$project->abstract}} </span>
                                                </a>
                                            </td>
                                        </tr>
                                    </table>
     ...
     <!--  <span><center>To report techincal issues submit feedback to META+LAB (link to route) </center></span> -->
</html>
