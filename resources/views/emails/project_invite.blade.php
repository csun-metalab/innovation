                        ...
                        <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                            <tr>
                                <td style="padding: 40px; font-weight: 300; text-align: center; font-family: sans-serif; font-size: 40px; mso-height-rule: exactly; color: #000000;">
                                    You've been invited <br> to join a project!  
                                    <br><br>
                                    <!-- Button : BEGIN -->
                                    ...
                                    <table role="presentation" cellspacing="0" cellpadding="0" border="0" align="center" style="margin: auto">
                                        <tr>
                                            <td style="padding: 40px; font-weight: 200; text-align: center; font-family: sans-serif; font-size: 30px; mso-height-rule: exactly; color: #555555;">{{str_limit($description, 450, '...')}}</span>
                                                </a>
                                            </td>
                                        </tr>
                                    </table>
