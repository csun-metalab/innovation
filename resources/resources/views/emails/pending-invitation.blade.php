...
<body width="100%" bgcolor="#ffffff" style="margin: 0;">
    <center style="width: 100%; background: #FFFFFF;">
                        ...
                        <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                            <tr>
                                <td style="padding: 40px; font-weight: 300; text-align: center; font-family: sans-serif; font-size: 26px; mso-height-rule: exactly; color: #000000;">
                                   The faculty member, {{ $member->first_name }} {{ $member->last_name }}, is requesting to be part of your project:
                                    <br><br>
                                    <!-- Button : BEGIN -->
                                    <table role="presentation" cellspacing="0" cellpadding="0" border="0" align="center" style="margin: auto">
                                        <tr>
                                            <td id="projectTitle" style="color:#D0021B; font-weight:300;font-size:22px;text-align:center;width:470px;">"{{$project->project_title}}"</td>
                                        </tr>
                                    </table>
                                    <br />
                                    <br />
                                    <table role="presentation" cellspacing="0" cellpadding="0" border="0" align="center" style="margin: auto">
                                        <tr>
                                            <td style="border-radius: 3px; background: #ffffff; text-align: center;" class="button-td">
                                                <a href="{{route('dashboard.invitations')}}" style="background: #CF0A2C; border: 15px solid #CF0A2C; font-family: sans-serif; font-size: 15px; line-height: 1.1; text-align: center; text-decoration: none; display: block; border-radius: 3px; font-weight: 100; color:#ffffff;" class="button-a">
                                                    &nbsp;&nbsp;&nbsp;&nbsp;<span class="stack-column-center" style="color:#ffffff">View Pending Invitations</span>&nbsp;&nbsp;&nbsp;&nbsp;
                                                </a>
                                                <br>
                                            </td>
                                        </tr>
      ...
      <br />
      <span><center>For questions regarding rewards and projects, please email research@csun.edu</center></span>
